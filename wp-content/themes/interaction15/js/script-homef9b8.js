...
/*
	var feed = new Instafeed({
        get: 'tagged',
        tagName: 'awesome',
        clientId: '83f3067a9113466695f90bacded01617',
...
*/
    ...
    var userFeed = new Instafeed({
		get: 'user',
		userId: 21780658,
		target: 'ixdconf-instagram-updates',
		limit: 24,
		accessToken: '21780658.467ede5.030064f8aa8e4207bd046dbd44dd808e'
	});
	userFeed.run();
	...
	var feed = new Instafeed({
        get: 'tagged',
        tagName: 'ixd15',
        target: 'ixda-instagram-updates',
        limit: 40,
        clientId: '83f3067a9113466695f90bacded01617',
        error: function(){
	        $('#ixd15-label').css('display', 'none');
        },
        success: function(){
	        $('#ixd15-label').css('display', 'block');
        }
        //template: '<a href="{{link}}"><img src="{{image}}" /></a>'
    });
    feed.run();
...
function handleTweets(tweets){
    ...
    while(n < x) {
      ...
      html += '<div class="span3 tweet-block">' + tweets[n] + '</div>';
...
twitterFetcher.fetch(ixdconf_twitter_handle);



/*
var ixd15_twitter_hashtag = {
  "id": '345095352640225281',
  "domId": 'example5',
  "maxTweets": 8,
  "enableLinks": true, 
...
twitterFetcher.fetch(ixd15_twitter_hashtag);
*/
